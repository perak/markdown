...
(function (g, f) {
  ...
  var Te = (l, e) => {
    ...
    Oe = (l, e, t, n) => {
      if (e && typeof e == "object" || typeof e == "function") for (let r of be(e)) !Re.call(l, r) && r !== t && Z(l, r, {
        get: () => e[r],
        enumerable: !(n = xe(e, r)) || n.enumerable
      });
      return l;
    };
  var we = l => Oe(Z({}, "__esModule", {
    value: !0
  }), l);
  var kt = {};
  Te(kt, {
  ...
  var ye = (() => {
    ...
    Ze = /(?!~)[\s\p{P}\p{S}]/u,
    Ge = /(?:[^\s\p{P}\p{S}]|~)/u,
    Ne = k(/link|precode-code|html/, "g").replace("link", /\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-", ye ? "(?<!`)()" : "(^^|[^`])").replace("code", /(?<b>`+)[^`]+\k<b>(?!`)/).replace("html", /<(?! )[^<>]*?>/).getRegex(),
...
`, e = e.substring(H.length + 1), g = C.slice(f);
        ...
        for (let u of i.items) {
          if (this.lexer.state.top = !1, u.tokens = this.lexer.blockTokens(u.text, []), u.task) {
            var _u$tokens$, _u$tokens$2;
            if (u.text = u.text.replace(this.rules.other.listReplaceTask, ""), ((_u$tokens$ = u.tokens[0]) === null || _u$tokens$ === void 0 ? void 0 : _u$tokens$.type) === "text" || ((_u$tokens$2 = u.tokens[0]) === null || _u$tokens$2 === void 0 ? void 0 : _u$tokens$2.type) === "paragraph") {
            ...
            if (p) {
              ...
              u.checked = c.checked, i.loose ? u.tokens[0] && ["paragraph", "text"].includes(u.tokens[0].type) && "tokens" in u.tokens[0] && u.tokens[0].tokens ? (u.tokens[0].raw = c.raw + u.tokens[0].raw, u.tokens[0].text = c.raw + u.tokens[0].text, u.tokens[0].tokens.unshift(c)) : u.tokens.unshift({
                type: "paragraph",
                raw: c.raw,
                text: c.raw,
                tokens: [c]
...
`), this.blockTokens(e, this.tokens);
    ...
    blockTokens(e, t = [], n = !1) {
      for (this.options.pedantic && (e = e.replace(m.tabCharGlobal, "    ").replace(m.spaceLine, "")); e;) {
        ...
        let r;
        if ((_this$options$extensi = this.options.extensions) !== null && _this$options$extensi !== void 0 && (_this$options$extensi = _this$options$extensi.block) !== null && _this$options$extensi !== void 0 && _this$options$extensi.some(s => (r = s.call({
          lexer: this
...
` + r.text, this.inlineQueue.pop(), this.inlineQueue.at(-1).src = s.text) : t.push(r);
    ...
    inlineTokens(e, t = []) {
      ...
      for (; e;) {
        ...
        s || (a = ""), s = !1;
        let o;
        if ((_this$options$extensi3 = this.options.extensions) !== null && _this$options$extensi3 !== void 0 && (_this$options$extensi3 = _this$options$extensi3.inline) !== null && _this$options$extensi3 !== void 0 && _this$options$extensi3.some(p => (o = p.call({
          lexer: this
        ...
        if (o = this.tokenizer.inlineText(u)) {
          ...
          let p = t.at(-1);
          (p === null || p === void 0 ? void 0 : p.type) === "text" ? (p.raw += o.raw, p.text += o.text) : t.push(o);
          continue;
        }
        if (e) {
  ...
  var P = class P {
    ...
    code({
      ...
      var _match;
      let r = (_match = (t || "").match(m.notSpaceStart)) === null || _match === void 0 ? void 0 : _match[0],
  ...
  var b = class l {
    ...
    parse(e) {
      ...
      for (let n = 0; n < e.length; n++) {
        ...
        let r = e[n];
        if ((_this$options$extensi5 = this.options.extensions) !== null && _this$options$extensi5 !== void 0 && (_this$options$extensi5 = _this$options$extensi5.renderers) !== null && _this$options$extensi5 !== void 0 && _this$options$extensi5[r.type]) {
          let s = r,
        ...
        default:
          {
            ...
            let i = r;
            (_this$defaults$extens = this.defaults.extensions) !== null && _this$defaults$extens !== void 0 && (_this$defaults$extens = _this$defaults$extens.childTokens) !== null && _this$defaults$extens !== void 0 && _this$defaults$extens[i.type] ? this.defaults.extensions.childTokens[i.type].forEach(s => {
              let a = i[s].flat(1 / 0);
